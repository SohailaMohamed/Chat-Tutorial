...
public class ChannelView extends VerticalLayout
    ...
    public ChannelView(ChatService chatService, AuthenticationContext authenticationContext) {
        ...
        setSizeFull();
        this.currentUserName = authenticationContext.getPrincipalName().orElse("Guest");
        ...
        messageInput.addSubmitListener(submitEvent -> System.out.println("submitEvent: " + submitEvent));
        add(messageInput);
    }
    @Override
